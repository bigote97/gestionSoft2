...
class personal:
    def __init__(self):
        ...
        #         # temp = empleadoEventual(temp['nombre'], temp['apellido'], temp['dni'], temp['salario'], temp['ventas'])
        #     else:
        #         temp['antiguedad'] = randint(0, 9)
        #         # temp = empleadoPermanente(temp['nombre'], temp['apellido'], temp['dni'], temp['salario'], temp['antiguedad'])
    ...
    def verificaString(self, str):
        ...
        for empleado in self.empleados:
            if (str in empleado['nombre'] or str in empleado['apellido']):
                aux = []
                if hasattr(empleado, 'esPermanente'):
